...
- **Saugroboter**: frei erweiterbare Liste. Bei einer [Ecovacs](https://github.com/mwilkens780/IPSymcon-Ecovacs)-Saugroboter-Instanz werden Batterie, Status, Saugstufe und letzte Reinigung angezeigt, dazu Start/Pause/Stopp/Zur-Basis-Buttons und Saugstufen-Auswahl -- diese steuern direkt die Ecovacs-Instanz, nicht nur eine Variable.
